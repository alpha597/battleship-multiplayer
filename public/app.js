document.addEventListener('DOMContentLoaded', () => {
    ...
    const singleButton = documnet.querySelector('#singlePlayerButton');
    ...
    let shotfired =-1;
    singleButton.addEventListener('click',startSinglePlayer);
    multiButton.addEventListener('click',startMutiPlayer);


    const socket = io();
    function startMutiPlayer(){
    ...
    startButton.addEventListener('click',() =>{
      if(allshipsPlaced){
        ...
        document.infoDisplay.innerHTML="Please place all the ships to start the game"
      }
    });
    // set event listeners for firing
